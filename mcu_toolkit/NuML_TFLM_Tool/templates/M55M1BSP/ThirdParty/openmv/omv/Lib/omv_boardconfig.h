...
// Architecture info
#define OMV_ARCH_STR            "M55M1" // 33 chars max
#define OMV_BOARD_TYPE          "M55M1"
...
#define OMV_FB_SIZE             ((320*240*2) + 1024)  // FB memory: header + QVGA/GS image
#define OMV_FB_ALLOC_SIZE       (160*1024)   // minimum fb alloc size
//#define OMV_STACK_SIZE          (8*1024)
//#define OMV_HEAP_SIZE           (64*1024)
#define OMV_JPEG_BUF_SIZE       (1*1024) // IDE JPEG buffer (header + data).
