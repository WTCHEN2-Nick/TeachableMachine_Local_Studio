...
/*
 * CMSIS ArmChina STAR-MC3 Core Peripheral Access Layer Header File
 */
...
#ifndef __CORE_STARMC3_H_GENERIC
#define __CORE_STARMC3_H_GENERIC
...
/* CMSIS STAR-MC3 definitions */

#define __STAR_MC                (3U)                               /*!< STAR-MC Core */
...
#endif /* __CORE_STARMC3_H_GENERIC */

#ifndef __CMSIS_GENERIC

#ifndef __CORE_STARMC3_H_DEPENDANT
#define __CORE_STARMC3_H_DEPENDANT
...
/* check device defines and use defaults */
  ...
  #ifndef __STARMC3_REV
    #define __STARMC3_REV               0x0000U
    #warning "__STARMC3_REV not defined in device header file; using default!"
  #endif
...
/**
  ...
  \brief Type definitions and defines for STAR-MC3 processor based devices.
*/
...
/**
  \brief   STAR-MC3 PMU events
  \note    Architectural PMU events can be found in armv8m_pmu.h
*/
#define ARMCHINASTARMC3_PMU_PAHB_ACCESS                      0xC301             /*!< Read or write access to the P-AHB write interface */
#define ARMCHINASTARMC3_PMU_DOSTIMEOUT_DOUBLE                0xC400             /*!< Denial of Service timeout has fired twice and caused buffers to drain to allow forward progress */
#define ARMCHINASTARMC3_PMU_DOSTIMEOUT_TRIPLE                0xC401             /*!< Denial of Service timeout has fired three times and blocked the LSU to force forward progress */
#define ARMCHINASTARMC3_PMU_CDE_INST_RETIRED                 0xC402             /*!< CDE instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_CX1_INST_RETIRED             0xC404             /*!< CDE CX1 instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_CX2_INST_RETIRED             0xC406             /*!< CDE CX2 instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_CX3_INST_RETIRED             0xC408             /*!< CDE CX3 instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_VCX1_INST_RETIRED            0xC40A             /*!< CDE VCX1 instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_VCX2_INST_RETIRED            0xC40C             /*!< CDE VCX2 instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_VCX3_INST_RETIRED            0xC40E             /*!< CDE VCX3 instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_VCX1_VEC_INST_RETIRED        0xC410             /*!< CDE VCX1 Vector instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_VCX2_VEC_INST_RETIRED        0xC412             /*!< CDE VCX2 Vector instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_VCX3_VEC_INST_RETIRED        0xC414             /*!< CDE VCX3 Vector instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_PRED                         0xC416             /*!< Cycles where one or more predicated beats of a CDE instruction architecturally executed. */
#define ARMCHINASTARMC3_PMU_CDE_STALL                        0xC417             /*!< Stall cycles caused by a CDE instruction. */
#define ARMCHINASTARMC3_PMU_CDE_STALL_RESOURCE               0xC418             /*!< Stall cycles caused by a CDE instruction because of resource conflicts */
#define ARMCHINASTARMC3_PMU_CDE_STALL_DEPENDENCY             0xC419             /*!< Stall cycles caused by a CDE register dependency. */
#define ARMCHINASTARMC3_PMU_CDE_STALL_CUSTOM                 0xC41A             /*!< Stall cycles caused by a CDE instruction are generated by the custom hardware. */
#define ARMCHINASTARMC3_PMU_CDE_STALL_OTHER                  0xC41B             /*!< Stall cycles caused by a CDE instruction are not covered by the other counters. */
#define ARMCHINASTARMC3_PMU_CAHB_WRITE_ACCESS                0xC420             /*!< M-AHB configuration: A Write beat transfer on Code-AHB */
#define ARMCHINASTARMC3_PMU_CAHB_READ_ACCESS                 0xC421             /*!< M-AHB configuration: A Read beat transfer on Code-AHB. */
...
#endif /* __CORE_STARMC3_H_DEPENDANT */
