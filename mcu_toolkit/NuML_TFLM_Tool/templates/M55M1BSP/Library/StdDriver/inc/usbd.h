...
#define EP19    19ul      /*!< Endpoint 19 \hideinitializer */
#define EP20    20ul      /*!< Endpoint 20 \hideinitializer */
#define EP21    21ul      /*!< Endpoint 21 \hideinitializer */
#define EP22    22ul      /*!< Endpoint 22 \hideinitializer */
#define EP23    23ul      /*!< Endpoint 23 \hideinitializer */
#define EP24    24ul      /*!< Endpoint 24 \hideinitializer */
...
#define USBD_EPINTSTS_EP0       USBD_EPINTSTS_EPEVT0_Msk    /*!< USB Endpoint 0 Event \hideinitializer */
...
#define USBD_EPINTSTS_EP3       USBD_EPINTSTS_EPEVT3_Msk    /*!< USB Endpoint 3 Event \hideinitializer */
#define USBD_EPINTSTS_EP4       USBD_EPINTSTS_EPEVT4_Msk    /*!< USB Endpoint 4 Event \hideinitializer */
#define USBD_EPINTSTS_EP5       USBD_EPINTSTS_EPEVT5_Msk    /*!< USB Endpoint 5 Event \hideinitializer */
#define USBD_EPINTSTS_EP6       USBD_EPINTSTS_EPEVT6_Msk    /*!< USB Endpoint 6 Event \hideinitializer */
#define USBD_EPINTSTS_EP7       USBD_EPINTSTS_EPEVT7_Msk    /*!< USB Endpoint 7 Event \hideinitializer */
#define USBD_EPINTSTS_EP8       USBD_EPINTSTS_EPEVT8_Msk    /*!< USB Endpoint 8 Event \hideinitializer */
#define USBD_EPINTSTS_EP9       USBD_EPINTSTS_EPEVT9_Msk    /*!< USB Endpoint 9 Event \hideinitializer */
#define USBD_EPINTSTS_EP10      USBD_EPINTSTS_EPEVT10_Msk   /*!< USB Endpoint 10 Event \hideinitializer */
...
#define USBD_EPINTSTS_EP15      USBD_EPINTSTS_EPEVT15_Msk   /*!< USB Endpoint 15 Event \hideinitializer */
...
#define USBD_EPINTSTS_EP18      USBD_EPINTSTS_EPEVT18_Msk   /*!< USB Endpoint 18 Event \hideinitializer */
#define USBD_EPINTSTS_EP19      USBD_EPINTSTS_EPEVT19_Msk   /*!< USB Endpoint 19 Event \hideinitializer */
#define USBD_EPINTSTS_EP20      USBD_EPINTSTS_EPEVT20_Msk   /*!< USB Endpoint 20 Event \hideinitializer */
...
#define USBD_CFG_DB_EN          USBD_CFG_DBEN_Msk           /*!< Double Buffer Enable \hideinitializer */
#define USBD_CFG_DBTGACTIVE     USBD_CFG_DBTGACTIVE_Msk     /*!< Double Buffer Toggle Active \hideinitializer */
...
/**
  ...
  *             (USBD_INT_SOF, USBD_INT_WAKEUP, USBD_INT_FLDET, USBD_INT_USB, USBD_INT_BUS)
  *
  * @return     None
  *
...
/**
  ...
  *             (USBD_INT_SOF, USBD_INTSTS_WAKEUP, USBD_INTSTS_FLDET, USBD_INTSTS_BUS, USBD_INTSTS_USB)
  *
  * @return     None
  *
...
/**
  * @brief    Get endpoint interrupt status
  *
  * @param    None
  *
  * @return   The value of USB_EPINTSTS register
  *
  * @details  Return all endpoint interrupt flags of USB_EPINTSTS register.
  * \hideinitializer
  */
#define USBD_GET_EP_INT_FLAG()      ((uint32_t)(USBD->EPINTSTS))

/**
  * @brief      Clear USB endpoint interrupt flag
  *
  * @param[in]  flag The combination of the specified endpoint interrupt flags.
  *             Each bit corresponds to a endpoint interrupt source.
  *             This parameter decides which endpoint interrupt flags will be cleared.
  *
  * @return     None
  *
  * @details    Clear USB related interrupt flags specified by flag parameter.
  * \hideinitializer
  */
#define USBD_CLR_EP_INT_FLAG(flag)     (USBD->EPINTSTS = (flag))
...
/**
  ...
  * \hideinitializer
  */
#define USBD_SET_DB_MODE(ep)          (*((__IO uint32_t *) ((uint32_t)&USBD->EP[0].CFG + (uint32_t)((ep) << 4))) |= USBD_CFG_DBEN_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define USBD_SET_SB_MODE(ep)          (*((__IO uint32_t *) ((uint32_t)&USBD->EP[0].CFG + (uint32_t)((ep) << 4))) &= (~USBD_CFG_DBEN_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define USBD_IS_DB_MODE(ep)           (*((__IO uint32_t *) ((uint32_t)&USBD->EP[0].CFG + (uint32_t)((ep) << 4))) & USBD_CFG_DBEN_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define USBD_SET_DB_ACTIVE(ep)        (*((__IO uint32_t *) ((uint32_t)&USBD->EP[0].CFG + (uint32_t)((ep) << 4))) |= USBD_CFG_DBTGACTIVE_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define USBD_SET_DB_INACTIVE(ep)      (*((__IO uint32_t *) ((uint32_t)&USBD->EP[0].CFG + (uint32_t)((ep) << 4))) &= (~USBD_CFG_DBTGACTIVE_Msk))
