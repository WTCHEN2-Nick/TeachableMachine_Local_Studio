 ...
 * @file     timer_pwm.h
 * @version  V1.00
 * @brief    TIMER_PWM driver header file
 *
...
/** @addtogroup TPWM_EXPORTED_CONSTANTS TIMER_PWM Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_CNTR_SYNC_DISABLE               (0UL)    /*!< Disable TIMER_PWM synchronous function \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_IFA_ZERO_POINT                  (0U)         /*!< Timer PWM counter equal to zero  \hideinitializer */
#define TPWM_IFA_PERIOD_POINT                (1U)         /*!< Timer PWM counter equal to period \hideinitializer */
#define TPWM_IFA_COMPARE_UP_COUNT_POINT      (2U)         /*!< Timer PWM counter up count to comparator value \hideinitializer */
#define TPWM_IFA_COMPARE_DOWN_COUNT_POINT    (3U)         /*!< Timer PWM counter down count to comparator value \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  External Event Trigger Pin Constant Definitions                                                        */
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_EXT_TGR_PIN_INT0                (0U)         /*!< Timer PWM external event trigger source form INT0 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT1                (1U)         /*!< Timer PWM external event trigger source form INT1 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT2                (2U)         /*!< Timer PWM external event trigger source form INT2 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT3                (3U)         /*!< Timer PWM external event trigger source form INT3 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT4                (4U)         /*!< Timer PWM external event trigger source form INT4 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT5                (5U)         /*!< Timer PWM external event trigger source form INT5 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT6                (6U)         /*!< Timer PWM external event trigger source form INT6 pin \hideinitializer */
#define TPWM_EXT_TGR_PIN_INT7                (7U)         /*!< Timer PWM external event trigger source form INT7 pin \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  External Event Trigger Counter Action Constant Definitions                                             */
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_EXT_TGR_COUNTER_RESET              (0U)      /*!< Timer PWM external event trigger counter reset \hideinitializer */
#define TPWM_EXT_TGR_COUNTER_START              (1U)      /*!< Timer PWM external event trigger counter start \hideinitializer */
#define TPWM_EXT_TGR_COUNTER_RESET_AND_START    (2U)      /*!< Timer PWM external event trigger counter reset and start \hideinitializer */
...
/**
  ...
  * @return     None
  *
  * @details    This macro is used to enable independent mode of TIMER_PWM module and complementary mode will be disabled.
  * \hideinitializer
  */
...
/**
  ...
  * @return     None
  *
  * @details    This macro is used to set the prescaler of specified TIMER_PWM.
...
/**
  ...
  *
  * @details    This macro is used to get the period of specified TIMER_PWM.
  * \hideinitializer
  */
...
/**
  ...
  *
  * @details    This macro is used to get the comparator value of specified TIMER_PWM.
  * \hideinitializer
  */
...
/**
  ...
  * @return     None
  *
  * @details    This macro is used to clear counter of specified TIMER_PWM.
  * \hideinitializer
  */
...
/**
  ...
  * @return     None
  *
  * @details    This macro is used to trigger synchronous event by specified TIMER_PWM.
