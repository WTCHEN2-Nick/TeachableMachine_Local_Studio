...
/**
  ...
  * @param[in] u32Data0 DAC0 12 bit conversion data, valid range are between 0~0xFFF.
  * @param[in] u32Data1 DAC1 12 bit conversion data, valid range are between 0~0xFFF.
  * @return None
  * @details 12 bit left alignment: user has to load data into DAC_GRPDAT[15:4] bits.
