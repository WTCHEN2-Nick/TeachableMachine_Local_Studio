...
#define ACMP_VREF_CRV2SSEL_VDDA       ACMP_VREF_CRV0SSEL_VDDA
#define ACMP_VREF_CRV2SSEL_INTVREF    ACMP_VREF_CRV0SSEL_INTVREF
#define ACMP_VREF_CRV3SSEL_VDDA       ACMP_VREF_CRV1SSEL_VDDA
#define ACMP_VREF_CRV3SSEL_INTVREF    ACMP_VREF_CRV1SSEL_INTVREF
...
/**
  ...
  * \hideinitializer
  */
#define ACMP_SET_FILTER(acmp, u32ChNum, u32Cnt) ((acmp)->CTL[(u32ChNum)] = ((acmp)->CTL[(u32ChNum)] & ~(ACMP_CTL_FILTSEL_Msk | ACMP_CTL_FCLKDIV_Msk)) | (u32Cnt))
