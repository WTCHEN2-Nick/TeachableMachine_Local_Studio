...
#define ECAP_CAP_INPUT_SRC_FROM_ACMP          (1UL)  /*!< CAP input source from ACMP           \hideinitializer */
#define ECAP_CAP_INPUT_SRC_FROM_CH            (2UL)  /*!< CAP input source from CH of EQEI     \hideinitializer */

#define ECAP_CNT_CLR_EVENT_DISABLE            (0UL)    /*!< Input channel counter cleared event disabled             */
#define ECAP_CNT_CLR_BY_CMP                   (ECAP_CTL0_CMPCLREN_Msk)    /*!< Input channel counter cleared by Compare-Match           */
...
/**
  ...
  *                  - \ref ECAP_CAP_INPUT_SRC_FROM_ACMP
