...
/*---------------------------------------------------------------------------------------------------------*/
#define BPWM_SSCTL_SSRC_EPWM0                     (0UL<<BPWM_SSCTL_SSRC_Pos)    /*!< Synchronous start source comes from EPWM0  */
#define BPWM_SSCTL_SSRC_EPWM1                     (1UL<<BPWM_SSCTL_SSRC_Pos)    /*!< Synchronous start source comes from EPWM1  */
...
/*---------------------------------------------------------------------------------------------------------*/
#define BPWM_DUTY_INT_DOWN_COUNT_MATCH_CMP        (BPWM_INTEN_CMPDIEN0_Msk)   /*!< BPWM duty interrupt triggered if down count match comparator \hideinitializer */
#define BPWM_DUTY_INT_UP_COUNT_MATCH_CMP          (BPWM_INTEN_CMPUIEN0_Msk)   /*!< BPWM duty interrupt triggered if up down match comparator \hideinitializer */
