...
typedef struct
{
     ...
     * |        |          |18 = Channel connects to UART9_TX.
     * |        |          |19 = Channel connects to UART9_RX.
     ...
     * |        |          |24 = Channel connects to USCI0_TX.
     * |        |          |25 = Channel connects to USCI0_RX.
     * |        |          |26 = Channel connects to QSPI0_TX.
     * |        |          |27 = Channel connects to QSPI0_RX.
     * |        |          |28 = Channel connects to QSPI1_TX.
     * |        |          |29 = Channel connects to QSPI1_RX.
     * |        |          |30 = Channel connects to SPI0_TX.
     * |        |          |31 = Channel connects to SPI0_RX.
     * |        |          |32 = Channel connects to SPI1_TX.
     * |        |          |33 = Channel connects to SPI1_RX.
     * |        |          |34 = Channel connects to SPI2_TX.
     * |        |          |35 = Channel connects to SPI2_RX.
     * |        |          |36 = Channel connects to SPI3_TX.
     * |        |          |37 = Channel connects to SPI3_RX.
     * |        |          |38 = Channel connects to ACMP0.
     * |        |          |39 = Channel connects to ACMP1.
     * |        |          |40 = Channel connects to ACMP2.
     * |        |          |41 = Channel connects to ACMP3.
     * |        |          |42 = Channel connects to EPWM0_P1_RX.
     * |        |          |43 = Channel connects to EPWM0_P2_RX.
     * |        |          |44 = Channel connects to EPWM0_P3_RX.
     * |        |          |45 = Channel connects to EPWM1_P1_RX.
     * |        |          |46 = Channel connects to EPWM1_P2_RX.
     * |        |          |47 = Channel connects to EPWM1_P3_RX.
     * |        |          |48 = Channel connects to I2C0_TX.
     * |        |          |49 = Channel connects to I2C0_RX.
     * |        |          |50 = Channel connects to I2C1_TX.
     * |        |          |51 = Channel connects to I2C1_RX.
     * |        |          |52 = Channel connects to I2C2_TX.
     * |        |          |53 = Channel connects to I2C2_RX.
     * |        |          |54 = Channel connects to I2C3_TX.
     * |        |          |55 = Channel connects to I2C3_RX.
     * |        |          |56 = Channel connects to I2S0_TX.
     * |        |          |57 = Channel connects to I2S0_RX.
     * |        |          |58 = Channel connects to I2S1_TX.
     * |        |          |59 = Channel connects to I2S2_RX.
     * |        |          |60 = Channel connects to TMR0.
     * |        |          |61 = Channel connects to TMR1.
     * |        |          |62 = Channel connects to TMR2.
     * |        |          |63 = Channel connects to TMR3.
     ...
     * |        |          |71 = Channel connects to EPWM0_CH3_TX.
     * |        |          |72 = Channel connects to EPWM0_CH4_TX.
     * |        |          |73 = Channel connects to EPWM0_CH5_TX.
     * |        |          |74 = Channel connects to EPWM1_CH0_TX.
     * |        |          |75 = Channel connects to EPWM1_CH1_TX.
     * |        |          |76 = Channel connects to EPWM1_CH2_TX.
     * |        |          |77 = Channel connects to EPWM1_CH3_TX.
     * |        |          |78 = Channel connects to EPWM1_CH4_TX.
     * |        |          |79 = Channel connects to EPWM1_CH5_TX.
     * |        |          |80 = Channel connects to EINT0.
     * |        |          |81 = Channel connects to EINT1.
     * |        |          |82 = Channel connects to EINT2.
     * |        |          |83 = Channel connects to EINT3.
     * |        |          |84 = Channel connects to EINT4.
     * |        |          |85 = Channel connects to EINT5.
     * |        |          |86 = Channel connects to EINT6.
     * |        |          |87 = Channel connects to EINT7.
     * |        |          |88 = Reserved.
     * |        |          |89 = Reserved.
     * |        |          |90 = Channel connects to PSIO_TX.
     * |        |          |91 = Channel connects to PSIO_RX.
     * |        |          |92 = Channel connects to I3C0_TX.
     * |        |          |93 = Channel connects to I3C0_RX.
     * |        |          |94 = Channel connects to ETMC_RX.
     * |        |          |95 = Channel connects to SWODEC.
     * |        |          |Others = Reserved.
...
#define PDMA_TOUTEN_TOUTENn_Msk          (0xfffful << PDMA_TOUTEN_TOUTENn_Pos)             /*!< PDMA_T::TOUTEN: TOUTENn Mask          */
...
#define PDMA_TOUTIEN_TOUTIENn_Msk        (0xfffful << PDMA_TOUTIEN_TOUTIENn_Pos)           /*!< PDMA_T::TOUTIEN: TOUTIENn Mask        */
