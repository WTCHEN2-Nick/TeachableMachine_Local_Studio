...
// #include "hyperram_code.h"  /* internal flash deployment: HyperRAM unused */
...
static void SYS_Init(void)
{
    ...
    // HyperRAM_PinConfig(HYPERRAM_SPIM_PORT);  /* internal flash deployment: HyperRAM unused */
    SDCard_PinConfig();
}
...
int BoardInit(void)
{
    ...
    // HyperRAM_Init(HYPERRAM_SPIM_PORT);  /* internal flash deployment: HyperRAM unused */
    /* Enter direct-mapped mode to run new applications */
    // SPIM_HYPER_EnterDirectMapMode(HYPERRAM_SPIM_PORT);  /* internal flash deployment: HyperRAM unused */
	/* SDH open SD card*/
