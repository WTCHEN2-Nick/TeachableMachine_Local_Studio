/* Auto-reconciled by NuML Application Builder v0.1.7.
 * Base schema: ffconf.h copied with this generated M55M1BSP/FatFs.
 * Compatible settings from NuML's application config are preserved.
 */
